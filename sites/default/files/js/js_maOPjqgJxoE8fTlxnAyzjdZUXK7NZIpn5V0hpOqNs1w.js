...
$( document ).ready(function() {
  var arrowDownClickHandler = function(){
    $(this).hide();
  ...
  $('.intro-container .text-container .arrow').on('click', arrowDownClickHandler);
  $('.intro-container .text-container .arrow').on('touchstart', arrowDownClickHandler);
